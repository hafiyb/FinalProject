...
import { getExpenses, removeExpenses } from "../../actions";
        ...
        <View style={modal.centeredView}>
          ...
          <View style={modal.modalView}>
            <View style={{flexDirection:'row',justifyContent:'space-between',margin:20}}>
              ...
              <Text style={{fontWeight:'bold', fontSize:20}}>Add new Expenses entry</Text>
            </View>
            ...
            <View style={styles.container}>
                <Text style={{margin:50, fontSize:30,height:40, fontWeight:'bold'}}>Expenses</Text>
            </View>
          ...
          rightOpenValue={-75}>
            ...
            renderItem={(data) => (
              <EntryTab 
              status={data.item.status} type={data.item.type}  value={data.item.value}  entry_date={data.item.entry_date} table='expense' id={data.item.id}
              />
            )}>
            </FlatList>
            ...
            <TouchableOpacity
              ...
              onPress={() => props.navigation.navigate('ExpensesModal')}

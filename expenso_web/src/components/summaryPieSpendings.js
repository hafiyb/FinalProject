...
const SummaryPieSpendings = () => {
  ...
  const data = {
    labels: ['Rents', 'Bills', 'Loans', 'Food', 'Groceries', 'Misc.'],
    datasets: [
      {
        label: 'Expenses',
        data: [
...
export default SummaryPieSpendings

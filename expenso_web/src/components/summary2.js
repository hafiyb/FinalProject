...
const Summary2 = () =>{
    ...
    const [sumTotal, setsummaryTotal] = useState(false)
    const [sumPieEarnings, setsummaryPieEarnings] = useState(true)
    const [sumPieSpendings, setsummaryPieSpendings] = useState(true)
